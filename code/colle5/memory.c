...
// alloue de la mémoire sur la pile. Lorsque la fonction termine, cette zone mémoire
// n'existe donc plus : il ne faut donc surtout pas retourner un pointeur vers cette zone.
